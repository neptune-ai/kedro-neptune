...
def _test_planets_structure(run: neptune.Run, travel_speed: int = 10000):
...
class TestPlanetsParallel:
    def test_parallel(self):
        ...
        run.wait()
        _test_planets_structure(run)


class TestPlanetsSequential:
